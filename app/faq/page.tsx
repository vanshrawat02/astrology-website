...
export default function FAQPage() {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "You can book directly by filling the contact form on our website or sending a message on WhatsApp (+91 99999 99999). We support UPI, Bank Transfer, GPay, PhonePe, and Credit/Debit Cards.",
    },
  ];
